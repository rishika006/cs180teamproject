            ...
            while ((message = reader.readLine()) != null) {
                ...
                switch (message) {
                    ...
                    case "6":
                        ...
                        User contact = helper.getUser(contactUsername);
                        if ( contact != null  && !contact.getPhone().equals(contactPhone)) {
                            writer.println("User and Phone number do not match. Try Again.");
                        } else {
                            String result6 = user_addContact(user, contact);
